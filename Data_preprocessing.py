...
categorical_features = st.checkbox('Обработаем категориальные данные:')
if categorical_features:
  st.write("""
  Попробуем несколько способов обработки категориальных данных. Во-первых столбец "пол" можно перевести в бинарный признак и заменить M, F на 0 и 1
  """)
